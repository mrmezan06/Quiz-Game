...
public class Quiz10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(bundle!=null){
            ...
            Toast.makeText(Quiz10.this, "Nothing will get!", Toast.LENGTH_SHORT).show();
        }
        ...
        submit2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try{
                    ...
                    if(ans.equals("Republic of Bangladesh")){
                        sc2 += 10;
        ...
        next2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(Quiz10.this,Quizfinal.class);
